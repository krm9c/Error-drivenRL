...
# python cartpole_dual.py --version single_grad 
# python cartpole_dual.py --version double_grad 
# python cartpole_dual.py --version single_EDL 
python cartpole_dual_v1.py --version double_EDL 
